...
<script>
  ...
  <body>
        ...
        <div class="main-panel">
          ...
          <h3 class="page-title"> GÖNDERİLEN MESAJLAR </h3>
          ...
          <?php
            ...
            use PhpParser\Node\Stmt\TryCatch;
                            ...
                            $sql = "SELECT recipient_id,subject,date,message FROM message WHERE sender_id=".$_GET['id']." ORDER BY id DESC";
                            ...
                            if($result->num_rows > 0)
                                {
                                    ...
                                    {
                                        $sql1 = "SELECT student_number,name,lastname FROM login_student WHERE id=".$row['recipient_id']."";
                                        ...
                                        if($result1->num_rows > 0)
                                        {
                                            while($row1 = $result1->fetch_assoc()) 
                                            {
                                                echo "<div class='details-container'>
                                                    <details> ";
                                                    echo "<summary class='summary'><b>".$row['subject']." </b><p class='mb-0'>Alıcı: ".$row1['name']." ".$row1['lastname']." / ".$row['date']."</p></summary> 
                                                    <div class='details'>";
