  ...
  <body>
        ...
        <div class="main-panel">
          ...
          <?php
                    ...
                    $sql = "SELECT employee_number,branch FROM login_academician WHERE id=".$_GET['id']."";
                        ...
                        <div class="card">
                          ...
                          <i class="mdi mdi-school icon-md text-dark"></i>
                            ...
                            while($row = $result->fetch_assoc()) {
                              echo "Akademisyen Numarası ";
                              echo $row['employee_number'];
                            }}?></h2>
                            <h3 class="mb-0 font-weight-bold mt-2 text-dark"><?php 
                            $sql = "SELECT branch FROM login_academician WHERE id=".$_GET['id']."";
                            $result = $conn->query($sql);
                            if($result->num_rows > 0)
                            {
                            while($row = $result->fetch_assoc()) {
